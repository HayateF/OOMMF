/* modified to spinhevolve.cc from spintevolve.h */
...
#ifndef _ANV_SPINHEVOLVE
#define _ANV_SPINHEVOLVE
...
/* End includes */
class Anv_SpinHEvolve:public Oxs_TimeEvolver {
private:
  ...
  Oxs_ScalarOutput<Anv_SpinHEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Anv_SpinHEvolve> dE_dt_output;
  Oxs_ScalarOutput<Anv_SpinHEvolve> delta_E_output;
  Oxs_ScalarOutput<Anv_SpinHEvolve> ave_u_output;
  Oxs_VectorFieldOutput<Anv_SpinHEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Anv_SpinHEvolve> mxH_output;
  Oxs_VectorFieldOutput<Anv_SpinHEvolve> spin_torque_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Anv_SpinHEvolve::* rkstep_ptr));
  ...
  Anv_SpinHEvolve(const Anv_SpinHEvolve&);
  Anv_SpinHEvolve& operator=(const Anv_SpinHEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Anv_SpinHEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Anv_SpinHEvolve();
